...
const ThumbSlide = ({i, el, slideNum, callback, deleteSlide}) => {
    return (
        <div className={`thumb__slide ${slideNum === i ? 'active' : ''}`} onClick={() => callback(i)}>
            <img src={el} alt="" />

            {/* <div className="cross"></div> */}

            <div className="label_container">
                <div className="label_item" onClick={(e) => deleteSlide(e, i)}>
